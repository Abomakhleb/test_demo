...
public final class changepass_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t     \t\r\n");
      out.write("\t\t\t     \t<tr>\r\n");
      out.write("\t\t\t     \t\t<td><font color=\"white\">Admin Id</font></td>\r\n");
      out.write("\t\t\t     \t\t<td>:</td>\r\n");
      out.write("\t\t\t     \t\t<td>\r\n");
      ...
      out.write("\t\t\t     \t\r\n");
      out.write("\t\t\t     \t<tr>\r\n");
      out.write("\t\t\t     \t\t<td><font color=\"white\">Current Password</font></td>\r\n");
      out.write("\t\t\t     \t\t<td>:</td>\r\n");
      out.write("\t\t\t     \t\t<td>\r\n");
      ...
      out.write("\t\t\t     \t\r\n");
      out.write("\t\t\t     \t<tr>\r\n");
      out.write("\t\t\t     \t\t<td><font color=\"white\">New Password </font></td>\r\n");
      out.write("\t\t\t     \t\t<td>:</td>\r\n");
      out.write("\t\t\t     \t\t<td>\r\n");
      ...
      out.write("\t\t\t     \t\r\n");
      out.write("\t\t\t     \t<tr>\r\n");
      out.write("\t\t\t     \t\t<td><font color=\"white\">Confirm new password</font></td>\r\n");
      out.write("\t\t\t     \t\t<td>:</td>\r\n");
      ...
      out.write("\t\t\t     \t<input type=\"submit\" value=\"Change Pass\" style=\"background-color:green;\" />\r\n");
      out.write("\t\t\t     \t\r\n");
      out.write("\t\t\t     \t</td>\r\n");
      out.write("\t\t\t     \t</tr>\r\n");
      out.write("\t\r\n");
...
if(no==1)
{
      ...
      out.write("\t\t\t\t<script>\r\n");
      out.write("\r\n");
      out.write("    alert('Opps,your current password is wrong ..!')\r\n");
      out.write("\r\n");
      out.write("  </script>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t");
...
if(no==2)
{
      ...
      out.write("\t\t\t\t<script>\r\n");
      out.write("\r\n");
      out.write("    alert('Opps,your new password do not match with confirm password ..!')\r\n");
      out.write("\r\n");
      out.write("  </script>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t");
...
if(no==4)
{
      ...
      out.write("\t\r\n");
      out.write("\t\t\t<script>\r\n");
      out.write("\t\t\t alert('Your Password Updated Successfully....!')\r\n");
      out.write("\t\t\t </script>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t");
