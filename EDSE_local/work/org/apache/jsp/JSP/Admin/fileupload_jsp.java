...
//hs.setAttribute("useid1",id);
      ...
      out.write("\t\t\t     \t\r\n");
      out.write("\t\t\t     \t<tr>\r\n");
      out.write("\t\t\t     \t\t<td><font color=\"white\">Choose Your File</font></td>\r\n");
      out.write("\t\t\t     \t\t<td>:</td>\r\n");
      out.write("\t\t\t     \t\t<td>\r\n");
      ...
      out.write("\t\t\t     </table>\r\n");
      out.write("\t\t\t     <br><br>\r\n");
      out.write("\t\t\t\t<input class=\"gradientbuttons\" type=\"submit\" name=\"submit\" value=\"Upload\" style=\"position:absolute;top:180px; background-color:green; left:100px;\"/>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
	...
	if(Utility.parse(request.getParameter("no"))==2)
	{
      ...
      out.write("    \t\t<script>\r\n");
      out.write("\r\n");
      out.write("    alert('Opp's something went wrong.....!')\r\n");
      out.write("\r\n");
      out.write("  </script>\r\n");
      out.write("\t\t</div>\t\t\t\r\n");
      out.write("\t");
