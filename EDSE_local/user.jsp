...
<div id="wrapper">
	...
	<div id="two-columns">
	 <form  action="<%=request.getContextPath()%>/UserLogin" method="post"> 
        ...
        <p>User Login</p>   
            <input type="text" placeholder="user name" name="userid" class="box1 border1">
            <input type="password" name="password" placeholder="password" class="box1 border2">
            <input type="submit" name="password" class="send" value="Signin">
           <p><a href="usercheck.jsp" class="link-style">Check your mailid is registered or not</a></p>
        </div>
        </div>
		</div>
		</form>
