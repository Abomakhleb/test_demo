	...
	if(uid!=null && pass!=null && cpass!=null && uname!=null && email!=null && pno!=null && grade!=null)
	{
		if(pass.equals(cpass))
		{
			...
			}else
			{
				...
				boolean sendMailflag=flag;
				
				String msg=" User ID :"+uid+" User Password :"+pass;
				/*if(flag)
				{
					//String user_details=UserDAO.getUserdetails(uid);
					sendMailflag=CL_SendMail.sendPersonalizedMail(email, "send.user.details@gmail.com", "dhsinformatics", "User Loging Details", msg, "no", "smtp.gmail.com", "465");
					System.out.println("user id sent successfully to mail");
				}
				*/
