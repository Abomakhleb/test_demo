...
<form id="login" action="<%=request.getContextPath() %>/FileUpload" enctype="multipart/form-data" method="post">
			...
			<div class="tab" style="position:absolute;top:80px;left:100px;width:400px;">
			     ...
			     <table id="login">
			     	...
			     	<tr>
			     		<td><font color="white">Choose Your File</font></td>
			     		<td>:</td>
			     		<td>
			     ...
			     <br><br>
				<input class="gradientbuttons" type="submit" name="submit" value="Upload" style="position:absolute;top:180px; background-color:green; left:100px;"/>
			</div>
