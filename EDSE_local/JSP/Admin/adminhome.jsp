...
%>
                        ...
                        <div class="header">
                            ...
                            <header class="box box-white">
                                <a href="javascript:void(0)" class="js-site-title">
                                    <h1 class="box-text site-title-text">ADMIN</h1>    
                                </a>            
                            </header>
                            ...
                            <nav class="js-nav">
                                <ul class="nav-items-container">
                                    ...
                                    <li  class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-left">
                                        <a href="signup1.jsp" class="block-keep-ratio-content box-nav-item-link" target="afrm">
                                            <span class="box-text box-text-nav-item flexbox-center">END USER CREATION</span>
                                        </a>
                                    </li>

                                    <li class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-right">
                                        <a a href="<%=request.getContextPath()%>/JSP/User/users.jsp" target="afrm" class="block-keep-ratio-content box-nav-item-link">
                                            <span class="box-text box-text-nav-item flexbox-center">END USERS</span>
                                        </a>
                                    </li>

                                    <li  class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-left">
                                        <a href="<%=request.getContextPath()%>/JSP/Admin/cloud_config.jsp" target="afrm" class="block-keep-ratio-content box-nav-item-link">
                                        
                                            <span class="box-text box-text-nav-item flexbox-center">STORAGE AREA</span>
                                        </a>
                                    </li>

                                    <li  class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-right">
                                        <a href="<%=request.getContextPath()%>/Diffekeygen?ownerid=<%=id%>" target="afrm" class="block-keep-ratio-content box-nav-item-link">
                                            <span class="box-text box-text-nav-item flexbox-center">Diffie Hellman Key_Gen</span>
                                        </a>
                                    </li>
                                         <li  class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-left">
                                        <a href="<%=request.getContextPath()%>/HashkeyGeneration?ownerid=<%=id%>" target="afrm" class="block-keep-ratio-content box-nav-item-link">
                                            <span class="box-text box-text-nav-item flexbox-center">ACCESSKEY GENERATION</span>
                                        </a>
                                    </li>

                                    <li  class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-right">
                                        <a href="<%=request.getContextPath()%>/JSP/Admin/fileupload1.jsp" target="afrm" class="block-keep-ratio-content box-nav-item-link">
                                            <span class="box-text box-text-nav-item flexbox-center">STORE FILES</span>
                                        </a>
                                    </li>
                                    ...
                                    <li data-nav-item-id="page-3" class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-left">
                                        <a href="<%=request.getContextPath()%>/SendPublicKey1?ownerid=<%=id%>" target="afrm" class="block-keep-ratio-content box-nav-item-link">
                                            <span class="box-text box-text-nav-item flexbox-center">AGGKEY SENDING</span>
                                        </a>
                                    </li>
                                    ...
                                    <li data-nav-item-id="page-4" class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-right">
                                        <a href="<%=request.getContextPath()%>/JSP/Admin/keyword_details.jsp" target="afrm" class="block-keep-ratio-content box-nav-item-link">
                                            <span class="box-text box-text-nav-item flexbox-center">DISPALY KEY RANK</span>
                                        </a>
                                    </li>
                                    <li data-nav-item-id="page-3" class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-left">
                                        <a href="<%=request.getContextPath() %>/ChangePass?name=<%=id%>&no=1&id=<%=id %>" target="afrm" class="block-keep-ratio-content box-nav-item-link">
                                    ...
                                    <li data-nav-item-id="page-4" class="block-keep-ratio block-keep-ratio-1-1 block-width-half box box-white box-nav-item js-nav-item pull-xs-right">
                                        <a  href="<%=request.getContextPath()%>/SignOut?no=1" class="block-keep-ratio-content box-nav-item-link">
                                            <span class="box-text box-text-nav-item flexbox-center">SIGN OUT</span>
                                        </a>
                                    </li>
                                </ul>
                            </nav>    
    ...
    <div id="contentframe" style="position:relative; top: -1000px; left:500px;">
